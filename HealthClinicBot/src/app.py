...
class ChatBot:
    #Defining a init method(consturctor for instances)
    def __init__(self):        
        self.user_name = ""         #Initializing instance variables 
        self.facility_type = ""     #Initializing instance variables 

    #creating a handle_message method that handles user message
...
@app.route('/submit_message', methods=['POST'])     #receives a user message aa a POST request
def submit_message():
